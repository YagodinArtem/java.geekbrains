...
import ru.geekbrains.level1.lesson8.impl.core.CrossZero;
import ru.geekbrains.level1.lesson8.settings.FieldConst;
...
public class StartWindow extends JFrame {
     ...
     * также передаются настройки для построения игрового экрана.
     */
